...
Database:InitializeTable('users', {
    ...
    ['name'] =          { primary = false,  unique = false, required = true,    type = 'VARCHAR',   length = 40,    default = 'NONE',                                   foreign_key = nil, extra = nil },
    ...
    ['position'] =      { primary = false,  unique = false, required = true,    type = 'VARCHAR',   length = 70,    default = '{"x":0.0,"y":0.0,"z":0.0,"h":0.0}',      foreign_key = nil, extra = nil },
